...
void setup()
{
  ...
  lcd.begin(16, 2);
  // تحديد ان الشاشه تخرج 16 حرفًا في الصف الواحد ولديها 2 صفوف

  lcd.clear();
  lcd.setCursor(0, 0);
  // (0,0)يُستخدم هذا السطر لتحديد موضع المؤشر و يتم تحديد الموقع
  //  الذي يعني البدء من أعلى الزاوية اليسرى للشاشة

  lcd.print(" Car speed Project ");
  lcd.setCursor(0, 1);
  // البدء من الزاوية اليسرى للصف الثاني
